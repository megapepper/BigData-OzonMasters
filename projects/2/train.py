...
#
from model import model, fields, fields_without_cat, numeric_features
...
#split train/test
#train_headers = [0]+[i for i in range(2, len(fields_without_cat))]
train_headers = [0]+[i for i in range(2, len(fields_without_cat)+1)]
